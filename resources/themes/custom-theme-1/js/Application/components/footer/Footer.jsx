                        ...
                        <div className="row">
                            <div className="col-md-6 footer--left">
                                ...
                                <div className="footer__contact g-text--default">
                                    ...
                                    <span className="footer__contact-address">Rua Afonso Cavalcante, 455</span>
                                    <span className="footer__contact-address">Rio de Janeiro, RJ, 20031-013</span>
                                </div>
                            </div>
                            <div className="col-md-6 footer--right">
                                ...
                                <div className="g-text--default">
                                    Carnival unites millions of people, turning Rio into the world
                                    capital of music, dance and joy. This is a holiday where traditions
                                    come to life on the streets, the scale is amazing, and the
                                    backstage shows the main show of the planet.
                                </div>
