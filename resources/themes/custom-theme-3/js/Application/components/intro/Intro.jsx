                ...
                <section className="с-intro g-pdMobile">
                    ...
                    <div className="intro__modal--wrapper">
                        <div className="intro__modal g-pdMobile">
                            <VideoPlayer
                                src="media/custom-theme-3/modal/video.mp4"
                                poster="media/custom-theme-3/modal/poster.jpg"
                            ...
                            <div className="col-md-12 c-content--inner">
                                ...
                                <div className="c-content--right">
                                    ...
                                    <div className="content__desc">
                                        Christmas is an annual holiday in world that
                                        takes place on December 25 and marks the birth
                                        of Jesus Christ.
                                    </div>
