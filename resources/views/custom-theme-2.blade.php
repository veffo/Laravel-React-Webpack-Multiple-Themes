...
<html lang="en">
    <head>
        ...
        <!-- Info for website -->
        <title>Multiple themes - theme 2</title>
        ...
        <!-- Styles -->
        <link type="text/css" rel="stylesheet" href="{{ mix("custom-theme-2/css/app.css", "build") }}" />
        ...
        <!-- Scripts -->
        <script src="{{ mix("custom-theme-2/js/app.js", "build") }}" defer></script>
